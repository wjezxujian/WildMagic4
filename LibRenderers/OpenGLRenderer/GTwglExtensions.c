...
{
    if (GTSupportsExtension("WGL_ARB_buffer_region"))
    {
...
{
    if (GTSupportsExtension("WGL_ARB_multisample"))
    {
...
{
    if (GTSupportsExtension("WGL_ARB_extensions_string"))
    {
...
{
    if (GTSupportsExtension("WGL_ARB_pixel_format"))
    {
...
{
    if (GTSupportsExtension("WGL_ARB_make_current_read"))
    {
...
{
    if (GTSupportsExtension("WGL_ARB_pbuffer"))
    {
...
{
    if (GTSupportsExtension("WGL_ARB_render_texture"))
    {
...
{
    if (GTSupportsExtension("WGL_ARB_pixel_format_float"))
    {
...
{
    if (GTSupportsExtension("WGL_EXT_display_color_table"))
    {
...
{
    if (GTSupportsExtension("WGL_EXT_extensions_string"))
    {
        GTExistsWglExtExtensionsString = 1;
        GT_GET_FUNCTION(swglGetExtensionsStringEXT);
        if (GT_EXT_OVERRIDE && !swglGetExtensionsStringARB)
        {
...
{
    if (GTSupportsExtension("WGL_EXT_make_current_read"))
    {
...
{
    if (GTSupportsExtension("WGL_EXT_pixel_format"))
    {
...
{
    if (GTSupportsExtension("WGL_EXT_pbuffer"))
    {
...
{
    GT_BODY_A1_RET(swglSwapIntervalEXT,iInterval,BOOL,FALSE);
}
/*--------------------------------------------------------------------------*/
...
{
    if (GTSupportsExtension("WGL_EXT_swap_control"))
    {
...
{
    if (GTSupportsExtension("WGL_EXT_depth_float"))
    {
...
{
    if (GTSupportsExtension("WGL_EXT_multisample"))
    {
